...
{
    /// <summary>
    /// Tile only used at edit/load time to define the cell that can contain a tile. If the PlacedGem is null, this amount as
    /// a random BonusGem, a BonusGem typeGoal will be picked at random from the list of available one.
    /// This tile won't have any visualGem component in play mode or in a build, as it's only useful during editing. 
    /// </summary>
    ...
    public class GemPlacerTile : TileBase
    {
        ...
        public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData)
        {
            ...
            //wo that tile is "invisible" during play (the BonusGem are gameobject handled by our system, not the tilemap)
